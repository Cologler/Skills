...
When [export](settings.html#export) is set, all `just` variables are exported as environment
variables.
...
See
[environment-variables](built-in-functions.html#environment-variables).