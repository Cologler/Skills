...
|`[doc(DOC)]`<sup>1.27.0</sup>|module, recipe|Set recipe or module’s [documentation comment](documentation-comments.html) to `DOC`.|
...
|`[group(NAME)]`<sup>1.27.0</sup>|module, recipe|Put recipe or module in [group](groups.html) `NAME`.|
...
|`[positional-arguments]`<sup>1.29.0</sup>|recipe|Turn on [positional arguments](avoiding-argument-splitting.html#positional-arguments) for this recipe.|
|`[private]`<sup>1.10.0</sup>|alias, recipe|Make recipe, alias, or variable private. See [Private Recipes](private-recipes.html).|
|`[script(COMMAND)]`<sup>1.32.0</sup>|recipe|Execute recipe as a script interpreted by `COMMAND`. See [script recipes](script-recipes.html) for more details.|
|`[script]`<sup>1.33.0</sup>|recipe|Execute recipe as script. See [script recipes](script-recipes.html) for more details.|
